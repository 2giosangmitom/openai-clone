...
const Possibility = () => (
  <div className="my-10 flex justify-around items-center" id="possibility">
    ...
    <div className="max-w-lg">
      <h4 className="text-sky-200 text-lg mb-2 md:text-base sm:text-sm">Request Early Access to Get Started</h4>
      <h1 className="gradient-text lg:text-3xl font-bold my-5 md:text-xl">
        The possibilities are <br /> beyond your imagination
      </h1>
      <p className="text-sky-200 mb-5 sm:text-sm lg:text-base">
